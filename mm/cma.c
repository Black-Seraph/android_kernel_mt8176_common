...
static unsigned long cma_bitmap_aligned_mask(const struct cma *cma, unsigned int align_order)
{
...
int cma_alloc_range_ok(struct cma *cma, size_t count, unsigned int align)
{
	unsigned long mask;
 ...
 */
struct page *cma_alloc_large(struct cma *cma, size_t count, unsigned int align)
{
	struct page *page;
	struct zone *zone;
